...
class HelperHandlers:
    ...
    async def reply_text_init(self) -> str:
        """
        Initializes the reply text from the database.

        Returns:
            str: The replt text.
        """
        self.reply_text = await get_reply_text_msg()
        return self.reply_text

    async def image_text_init(self) -> str:
        """
        Initialize the Picture Image from the Database,

        Returns:
             str: The Image Picture.
        """
        self.image_text = await get_img_text_msg()
        return self.image_text

    async def hunter_text_init(self) -> str:
        """
        Initialize The Picture Image from Database,

        Returns:
             str: Force Text Image.
        """
        self.hunter_text = await get_hun_text_msg()
        return self.hunter_text
